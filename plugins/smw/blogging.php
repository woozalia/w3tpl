...
/*----
  PURPOSE: wiki-based blogging for w3tpl
    This version depends on SMW, which is not necessarily the best way to do it.
  HISTORY:
    2012-11-02 rewriting essentially from scratch after Kate/server glitch
    2018-01-26 updated TagAPI f() name
    2018-02-10 made a smw subfolder so I could do a non-SMW version; smw-links is now smw/links
*/
$csModuleClass = 'xcModule_Blogging';
...
class Blog_Entry extends \fcPageData_SMW {
	...
	// TO DO: rest of post; section headers
	return $out;
    }
}
